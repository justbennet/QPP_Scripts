...
a=zeros(1,nP); a(1:min(nP,3))=20; a(4:end)=20; % for fast detection of QPP
...
load('myGlssr.mat',... % grayordinate indices of areas used as timing ...
    'ivxlpcc5','ivxlv2','ivxlm1','ivxlpf'); % references between regions
...
clstth=0.11:0.02:0.11+0.02*(nP-1); % cutt-off for h. clustering
